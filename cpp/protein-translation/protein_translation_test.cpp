...
{
    REQUIRE(vector<string>{"Methionine", "Phenylalanine", "Tryptophan"} == protein_translation::proteins("AUGUUUUGG"));
}
...
{
    REQUIRE(vector<string>{"Methionine", "Phenylalanine"} == protein_translation::proteins("AUGUUUUAA"));
}
...
{
    REQUIRE(vector<string>{"Tryptophan", "Cysteine", "Tyrosine"} == protein_translation::proteins("UGGUGUUAUUAAUGGUUU"));
}
