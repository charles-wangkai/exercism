...
{
    REQUIRE(vector<string>{"wink", "double blink", "close your eyes", "jump"} == secret_handshake::commands(15));
}

TEST_CASE("reverse_all_possible_actions")
{
    REQUIRE(vector<string>{"jump", "close your eyes", "double blink", "wink"} == secret_handshake::commands(31));
}
