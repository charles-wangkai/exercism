...
public class HouseTest {
	...
	public void verseTwo() {
		String expected = "This is the malt\n" + "that lay in the house that Jack built.";
		int verse = 2;
	...
	public void verseThree() {
		String expected = "This is the rat\n" + "that ate the malt\n" + "that lay in the house that Jack built.";
		int verse = 3;
	...
	public void verseFour() {
		String expected = "This is the cat\n" + "that killed the rat\n" + "that ate the malt\n"
				+ "that lay in the house that Jack built.";
		int verse = 4;
	...
	public void verseFive() {
		String expected = "This is the dog\n" + "that worried the cat\n" + "that killed the rat\n"
				+ "that ate the malt\n" + "that lay in the house that Jack built.";
		int verse = 5;
	...
	public void verseSix() {
		String expected = "This is the cow with the crumpled horn\n" + "that tossed the dog\n"
				+ "that worried the cat\n" + "that killed the rat\n" + "that ate the malt\n"
				+ "that lay in the house that Jack built.";
		int verse = 6;
	...
	public void verseSeven() {
		String expected = "This is the maiden all forlorn\n" + "that milked the cow with the crumpled horn\n"
				+ "that tossed the dog\n" + "that worried the cat\n" + "that killed the rat\n" + "that ate the malt\n"
				+ "that lay in the house that Jack built.";
		int verse = 7;
	...
	public void verseEight() {
		String expected = "This is the man all tattered and torn\n" + "that kissed the maiden all forlorn\n"
				+ "that milked the cow with the crumpled horn\n" + "that tossed the dog\n" + "that worried the cat\n"
				+ "that killed the rat\n" + "that ate the malt\n" + "that lay in the house that Jack built.";
		int verse = 8;
	...
	public void verseNine() {
		String expected = "This is the priest all shaven and shorn\n" + "that married the man all tattered and torn\n"
				+ "that kissed the maiden all forlorn\n" + "that milked the cow with the crumpled horn\n"
				+ "that tossed the dog\n" + "that worried the cat\n" + "that killed the rat\n" + "that ate the malt\n"
				+ "that lay in the house that Jack built.";
		int verse = 9;
	...
	@Test
	public void verse10() {
		String expected = "This is the rooster that crowed in the morn\n"
	...
	@Test
	public void verse11() {
		String expected = "This is the farmer sowing his corn\n" + "that kept the rooster that crowed in the morn\n"
				+ "that woke the priest all shaven and shorn\n" + "that married the man all tattered and torn\n"
				+ "that kissed the maiden all forlorn\n" + "that milked the cow with the crumpled horn\n"
				+ "that tossed the dog\n" + "that worried the cat\n" + "that killed the rat\n" + "that ate the malt\n"
				+ "that lay in the house that Jack built.";
