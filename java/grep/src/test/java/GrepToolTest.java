...
public class GrepToolTest {
	...
	public void setUp() throws IOException {
		List<String> iliadText = Arrays.asList("Achilles sing, O Goddess! Peleus' son;",
				"His wrath pernicious, who ten thousand woes", "Caused to Achaia's host, sent many a soul",
				"Illustrious into Ades premature,", "And Heroes gave (so stood the will of Jove)",
				"To dogs and to all ravening fowls a prey,", "When fierce dispute had separated once",
				"The noble Chief Achilles from the son", "Of Atreus, Agamemnon, King of men.");
		writeToFile("iliad.txt", iliadText);

		List<String> midsummerNightText = Arrays.asList("I do entreat your grace to pardon me.",
		...
		List<String> paradiseLostText = Arrays.asList("Of Mans First Disobedience, and the Fruit",
	...
	public void oneFileOneMatchPrintLineNumbersFlag() {
		...
		String actual = grepTool.grep("Forbidden", Collections.singletonList("-n"),
	...
	public void oneFileOneMatchCaseInsensitiveFlag() {
		...
		String actual = grepTool.grep("FORBIDDEN", Collections.singletonList("-i"),
				Collections.singletonList("paradise-lost.txt"));
	...
	public void oneFileOneMatchPrintFileNamesFlag() {
		...
		String actual = grepTool.grep("Forbidden", Collections.singletonList("-l"),
				Collections.singletonList("paradise-lost.txt"));
	...
	public void oneFileOneMatchEntireLinesFlag() {
		...
		String actual = grepTool.grep("With loss of Eden, till one greater Man", Collections.singletonList("-x"),
				Collections.singletonList("paradise-lost.txt"));
	...
	public void oneFileOneMatchMultipleFlags() {
		...
		String actual = grepTool.grep("OF ATREUS, Agamemnon, KIng of MEN.", Arrays.asList("-n", "-i", "-x"),
	...
	public void oneFileSeveralMatchesPrintLineNumbersFlag() {
		...
		String actual = grepTool.grep("may", Collections.singletonList("-n"),
	...
	public void oneFileSeveralMatchesMatchEntireLineFlag() {
		...
		String actual = grepTool.grep("may", Collections.singletonList("-x"),
				Collections.singletonList("midsummer-night.txt"));
	...
	public void oneFileSeveralMatchesCaseInsensitiveFlag() {
		...
		String actual = grepTool.grep("ACHILLES", Collections.singletonList("-i"),
				Collections.singletonList("iliad.txt"));
	...
	public void oneFileSeveralMatchesInvertedFlag() {
		...
		String actual = grepTool.grep("Of", Collections.singletonList("-v"),
				Collections.singletonList("paradise-lost.txt"));
	...
	public void oneFileNoMatchesVariousFlags() {
		...
		String actual = grepTool.grep("Gandalf", Arrays.asList("-n", "-l", "-x", "-i"),
				Collections.singletonList("iliad.txt"));
	...
	public void oneFileSeveralMatchesInvertedAndMatchEntireLinesFlags() {
		...
		String actual = grepTool.grep("Illustrious into Ades premature,", Arrays.asList("-x", "-v"),
				Collections.singletonList("iliad.txt"));
	...
	public void multipleFilesOneMatchNoFlags() {
		...
		String actual = grepTool.grep("Agamemnon", Collections.emptyList(),
	...
	public void multipleFilesSeveralMatchesNoFlags() {
		...
		String actual = grepTool.grep("may", Collections.emptyList(),
				Arrays.asList("iliad.txt", "midsummer-night.txt", "paradise-lost.txt"));
	...
	public void multipleFilesSeveralMatchesPrintLineNumbersFlag() {
		...
		String actual = grepTool.grep("that", Collections.singletonList("-n"),
				Arrays.asList("iliad.txt", "midsummer-night.txt", "paradise-lost.txt"));
	...
	public void multipleFilesOneMatchPrintFileNamesFlag() {
		...
		String actual = grepTool.grep("who", Collections.singletonList("-l"),
				Arrays.asList("iliad.txt", "midsummer-night.txt", "paradise-lost.txt"));
	...
	public void multipleFilesSeveralMatchesCaseInsensitiveFlag() {
		...
		String actual = grepTool.grep("TO", Collections.singletonList("-i"),
				Arrays.asList("iliad.txt", "midsummer-night.txt", "paradise-lost.txt"));
	...
	public void multipleFilesSeveralMatchesInvertedFlag() {
		...
		String actual = grepTool.grep("a", Collections.singletonList("-v"),
				Arrays.asList("iliad.txt", "midsummer-night.txt", "paradise-lost.txt"));
	...
	public void multipleFilesOneMatchEntireLinesFlag() {
		...
		String actual = grepTool.grep("But I beseech your grace that I may know", Collections.singletonList("-x"),
				Arrays.asList("iliad.txt", "midsummer-night.txt", "paradise-lost.txt"));
	...
	public void multipleFilesOneMatchMultipleFlags() {
		...
		String actual = grepTool.grep("WITH LOSS OF EDEN, TILL ONE GREATER MAN", Arrays.asList("-n", "-i", "-x"),
				Arrays.asList("iliad.txt", "midsummer-night.txt", "paradise-lost.txt"));
	...
	public void multipleFilesNoMatchesVariousFlags() {
		...
		String actual = grepTool.grep("Frodo", Arrays.asList("-n", "-l", "-x", "-i"),
				Arrays.asList("iliad.txt", "midsummer-night.txt", "paradise-lost.txt"));
	...
	public void multipleFilesSeveralMatchesFileFlagTakesPrecedenceOverLineNumberFlag() {
		...
		String actual = grepTool.grep("who", Arrays.asList("-n", "-l"),
				Arrays.asList("iliad.txt", "midsummer-night.txt", "paradise-lost.txt"));
