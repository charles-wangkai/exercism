...
public class BSTTest {
	...
	public void createsComplexTree() {
		BST<Integer> bst = new BST<>();
		List<Integer> expected = Collections.unmodifiableList(Arrays.asList(4, 2, 6, 1, 3, 5, 7));

		List<Integer> treeData = Collections.unmodifiableList(Arrays.asList(4, 2, 6, 1, 3, 7, 5));
	...
	public void sortsSingleElement() {
		BST<Integer> bst = new BST<>();
		List<Integer> expected = Collections.unmodifiableList(Collections.singletonList(4));
	...
	public void sortsCollectionOfTwoIfSecondInsertedIsSmallerThanFirst() {
		BST<Integer> bst = new BST<>();
		List<Integer> expected = Collections.unmodifiableList(Arrays.asList(2, 4));
	...
	public void sortsCollectionOfTwoIfSecondInsertedIsBiggerThanFirst() {
		BST<Integer> bst = new BST<>();
		List<Integer> expected = Collections.unmodifiableList(Arrays.asList(4, 5));
	...
	public void iteratesOverComplexTree() {
		BST<Integer> bst = new BST<>();
		List<Integer> expected = Collections.unmodifiableList(Arrays.asList(1, 2, 3, 4, 5, 6, 7));

		List<Integer> treeData = Collections.unmodifiableList(Arrays.asList(4, 2, 1, 3, 6, 7, 5));
		treeData.forEach(bst::insert);
