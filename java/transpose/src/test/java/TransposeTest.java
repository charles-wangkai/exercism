...
public class TransposeTest {
  ...
  public void twoCharactersInARow() {
    assertThat(transpose.transpose("A1")).isEqualTo("A" + "\n1");
  }

  @Test
  public void twoCharactersInAColumn() {
    assertThat(transpose.transpose("A\n" + "1")).isEqualTo("A1");
  }

  @Test
  public void simple() {
    assertThat(transpose.transpose("ABC\n" + "123")).isEqualTo("A1\n" + "B2\n" + "C3");
  }
  ...
  public void firstLineLongerThanSecondLine() {
    assertThat(transpose.transpose("The fourth line.\n" + "The fifth line."))
        .isEqualTo(
            "TT\n" + "hh\n" + "ee\n" + "  \n" + "ff\n" + "oi\n" + "uf\n" + "rt\n" + "th\n" + "h \n"
                + " l\n" + "li\n" + "in\n" + "ne\n" + "e.\n" + ".");
  }
  ...
  public void secondLineLongerThanFirstLine() {
    assertThat(transpose.transpose("The first line.\n" + "The second line."))
        .isEqualTo(
            "TT\n" + "hh\n" + "ee\n" + "  \n" + "fs\n" + "ie\n" + "rc\n" + "so\n" + "tn\n" + " d\n"
                + "l \n" + "il\n" + "ni\n" + "en\n" + ".e\n" + " .");
  }
  ...
  @Test
  public void square() {
    assertThat(transpose.transpose("HEART\n" + "EMBER\n" + "ABUSE\n" + "RESIN\n" + "TREND"))
        .isEqualTo("HEART\n" + "EMBER\n" + "ABUSE\n" + "RESIN\n" + "TREND");
  }

  @Test
  public void rectangle() {
    assertThat(transpose.transpose("FRACTURE\n" + "OUTLINED\n" + "BLOOMING\n" + "SEPTETTE"))
        .isEqualTo(
            "FOBS\n" + "RULE\n" + "ATOP\n" + "CLOT\n" + "TIME\n" + "UNIT\n" + "RENT\n" + "EDGE");
  }
