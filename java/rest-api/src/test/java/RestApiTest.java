...
public class RestApiTest {
  ...
  public static class UserManagementTest {
    ...
    public void getSingleUser() {
      ...
      assertEquals(
          expected,
          new RestApi(User.builder().setName("Adam").build(), User.builder().setName("Bob").build())
              .get(url, payload));
    }
  }
                  ...
                  new JSONArray()
                      .put(
                          new JSONObject()
                              .put("name", "Adam")
                              .put("owes", new JSONObject())
                              .put("owedBy", new JSONObject().put("Bob", 3.0))
                              .put("balance", 3.0))
                      .put(
                          new JSONObject()
                              .put("name", "Bob")
                              .put("owes", new JSONObject().put("Adam", 3.0))
                              .put("owedBy", new JSONObject())
                              .put("balance", -3.0)))
              .toString();
      String url = "/iou";
      JSONObject payload =
          new JSONObject().put("lender", "Adam").put("borrower", "Bob").put("amount", 3.0);
              ...
              .put(
                  ...
                  new JSONArray()
                      .put(
                          new JSONObject()
                              .put("name", "Adam")
                              .put("owes", new JSONObject().put("Bob", 3.0))
                              .put("owedBy", new JSONObject())
                              .put("balance", -3.0))
                      .put(
                          new JSONObject()
                              .put("name", "Bob")
                              .put("owes", new JSONObject().put("Chuck", 3.0))
                              .put("owedBy", new JSONObject().put("Adam", 3.0))
                              .put("balance", 0.0)))
              .toString();
      String url = "/iou";
      JSONObject payload =
          new JSONObject().put("lender", "Bob").put("borrower", "Adam").put("amount", 3.0);
              ...
              .put(
                  ...
                  new JSONArray()
                      .put(
                          new JSONObject()
                              .put("name", "Adam")
                              .put("owes", new JSONObject().put("Bob", 1.0))
                              .put("owedBy", new JSONObject())
                              .put("balance", -1.0))
                      .put(
                          new JSONObject()
                              .put("name", "Bob")
                              .put("owes", new JSONObject())
                              .put("owedBy", new JSONObject().put("Adam", 1.0))
                              .put("balance", 1.0)))
              .toString();
      String url = "/iou";
      JSONObject payload =
          new JSONObject().put("lender", "Adam").put("borrower", "Bob").put("amount", 2.0);
                  ...
                  new JSONArray()
                      .put(
                          new JSONObject()
                              .put("name", "Adam")
                              .put("owes", new JSONObject())
                              .put("owedBy", new JSONObject().put("Bob", 1.0))
                              .put("balance", 1.0))
                      .put(
                          new JSONObject()
                              .put("name", "Bob")
                              .put("owes", new JSONObject().put("Adam", 1.0))
                              .put("owedBy", new JSONObject())
                              .put("balance", -1.0)))
              .toString();
      String url = "/iou";
      JSONObject payload =
          new JSONObject().put("lender", "Adam").put("borrower", "Bob").put("amount", 4.0);
