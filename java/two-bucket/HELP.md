...
You can submit your solution using the `exercism submit src/main/java/TwoBucket.java src/main/java/Result.java src/main/java/UnreachableGoalException.java` command.
