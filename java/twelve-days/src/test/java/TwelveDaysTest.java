...
public class TwelveDaysTest {
  ...
  public void testVerseFive() {
    String expectedVerseFive =
        "On the fifth day of Christmas my true love gave to me: five Gold Rings, four Calling"
  ...
  public void testVerseNine() {
    String expectedVerseNine =
        "On the ninth day of Christmas my true love gave to me: nine Ladies Dancing, eight"
  ...
  public void testVerseTen() {
    String expectedVerseTen =
        "On the tenth day of Christmas my true love gave to me: ten Lords-a-Leaping, nine Ladies"
            + " Dancing, eight Maids-a-Milking, seven Swans-a-Swimming, six Geese-a-Laying, five"
  ...
  public void testVerseEleven() {
    String expectedVerseEleven =
        "On the eleventh day of Christmas my true love gave to me: eleven Pipers Piping, ten"
  ...
  public void testVerseTwelve() {
    String expectedVerseTwelve =
        "On the twelfth day of Christmas my true love gave to me: twelve Drummers Drumming, eleven"
  ...
  public void testFirstThreeVerses() {
    String expectedVersesOneToThree =
        "On the first day of Christmas my true love gave to me: a Partridge in a Pear Tree.\n\n"
            ...
            + " Partridge in a Pear Tree.\n\n"
            + "On the third day of Christmas my true love gave to me: three French Hens, two Turtle"
            + " Doves, and a Partridge in a Pear Tree.\n";
  ...
  public void testFourthToSixthVerses() {
    String expectedVersesFourToSix =
        "On the fourth day of Christmas my true love gave to me: four Calling Birds, three French"
            ...
            + " Rings, four Calling Birds, three French Hens, two Turtle Doves, and a Partridge in"
            + " a Pear Tree.\n";
  ...
  public void testSingWholeSong() {
    String expectedSong =
        "On the first day of Christmas my true love gave to me: a Partridge in a Pear Tree.\n"
            ...
            + " Doves, and a Partridge in a Pear Tree.\n"
            + "\n"
            + "On the eighth day of Christmas my true love gave to me: eight Maids-a-Milking, seven"
            + " Swans-a-Swimming, six Geese-a-Laying, five Gold Rings, four Calling Birds, three"
            + " French Hens, two Turtle Doves, and a Partridge in a Pear Tree.\n"
            + "\n"
            + "On the ninth day of Christmas my true love gave to me: nine Ladies Dancing, eight"
