...
public class RailFenceCipherTest {
  ...
  public void encodeWithTwoRails() {
    ...
    Assert.assertEquals(
        "XXXXXXXXXOOOOOOOOO", railFenceCipher.getEncryptedData("XOXOXOXOXOXOXOXOXO"));
  }
  ...
  public void encodeWithThreeRails() {
    ...
    Assert.assertEquals(
        "WECRLTEERDSOEEFEAOCAIVDEN", railFenceCipher.getEncryptedData("WEAREDISCOVEREDFLEEATONCE"));
  }
  ...
  public void decodeWithThreeRails() {
    railFenceCipher = new RailFenceCipher(3);
    Assert.assertEquals(
        "THEDEVILISINTHEDETAILS", railFenceCipher.getDecryptedData("TEITELHDVLSNHDTISEIIEA"));
  }
  ...
  public void decodeWithSixRails() {
    ...
    Assert.assertEquals(
        ...
        railFenceCipher.getDecryptedData(
