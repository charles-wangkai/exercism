...
public class PythagoreanTripletTest {
	...
	public void shouldMakeTripletsUpToTen() {
		final List<Long> actual = PythagoreanTriplet.makeTripletsList().withFactorsLessThanOrEqualTo(10).build()
				.stream().map(t -> t.calculateProduct()).sorted().collect(Collectors.toList());
	...
	public void shouldMakeTripletsElevenToTwenty() {
		final List<Long> actual = PythagoreanTriplet.makeTripletsList().withFactorsGreaterThanOrEqualTo(11)
	...
	public void shouldMakeTripletsAndFilterOnSum() {
		final List<Long> actual = PythagoreanTriplet.makeTripletsList().withFactorsLessThanOrEqualTo(100).thatSumTo(180)
