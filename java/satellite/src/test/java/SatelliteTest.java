...
public class SatelliteTest {
    ...
    public void rejectTraversalsOfDifferentLengths() {
        ...
        assertThat(expected).hasMessage("traversals must have the same length");
    }
    ...
    public void rejectInconsistentTraversalsOfSameLength() {
        ...
        IllegalArgumentException expected = assertThrows(IllegalArgumentException.class,
                () -> satellite.treeFromTraversals(preorder, inorder));
        assertThat(expected).hasMessage("traversals must have the same elements");
    }
    ...
    public void rejectTraversalsWithRepeatedItems() {
        ...
        IllegalArgumentException expected = assertThrows(IllegalArgumentException.class,
                () -> satellite.treeFromTraversals(preorder, inorder));
        assertThat(expected).hasMessage("traversals must contain unique items");
    }
}
