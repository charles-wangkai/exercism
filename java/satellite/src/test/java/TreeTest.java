...
public class TreeTest {
  ...
  public void inorder() {
    ...
    assertThat(tree.inorder()).containsExactly('A', 'B', 'C', 'D', 'E', 'F');
  }
  ...
  public void preorder() {
    ...
    assertThat(tree.preorder()).containsExactly('A', 'B', 'C', 'D', 'E', 'F');
  }
  ...
  public void postorder() {
    ...
    assertThat(tree.postorder()).containsExactly('A', 'B', 'C', 'D', 'E', 'F');
  }
}
