...
public class ForthEvaluatorTest {
  ...
  public void testErrorIfAdditionAttemptedWithNothingOnTheStack() {
    ...
    assertThat(expected).hasMessage("Addition requires that the stack contain at least 2 values");
  }
  ...
  public void testErrorIfDividingByZero() {
    ...
    assertThat(expected).hasMessage("Division by 0 is not allowed");
  }
  ...
  public void testErrorIfDivisionAttemptedWithNothingOnTheStack() {
    ...
    assertThat(expected).hasMessage("Division requires that the stack contain at least 2 values");
  }
  ...
  public void testDupCopiesAValueOnTheStack() {
    assertEquals(
        Arrays.asList(1, 1), forthEvaluator.evaluateProgram(Collections.singletonList("1 dup")));
  }
  ...
  public void testErrorIfDuplicatingAttemptedWithNothingOnTheStack() {
    ...
    assertThat(expected).hasMessage("Duplicating requires that the stack contain at least 1 value");
  }
  ...
  public void testErrorIfDroppingAttemptedWithNothingOnTheStack() {
    ...
    assertThat(expected).hasMessage("Dropping requires that the stack contain at least 1 value");
  }

  @Test
  public void testSwapSwapsTheTopTwosValueOnTheStackIfTheyAreTheOnlyOnes() {
    assertEquals(
        Arrays.asList(2, 1), forthEvaluator.evaluateProgram(Collections.singletonList("1 2 swap")));
  }
  ...
  public void testErrorIfSwappingAttemptedWithNothingOnTheStack() {
    ...
    assertThat(expected).hasMessage("Swapping requires that the stack contain at least 2 values");
  }
  ...
  public void testErrorIfOveringAttemptedWithNothingOnTheStack() {
    ...
    assertThat(expected).hasMessage("Overing requires that the stack contain at least 2 values");
  }
  ...
  public void testCanUseDifferentWordsWithTheSameName() {
    assertEquals(
        Arrays.asList(5, 6),
        forthEvaluator.evaluateProgram(
            Arrays.asList(": foo 5 ;", ": bar foo ;", ": foo 6 ;", "bar foo")));
  }
  ...
  public void testErrorIfEvaluatingAnUndefinedOperator() {
    ...
    assertThat(expected).hasMessage("No definition available for operator \"foo\"");
  }
