...
public class ParallelLetterFrequencyTest {
	...
	private String OdeAnDieFreude = "Freude schöner Götterfunken\n" + "Tochter aus Elysium,\n"
			+ "Wir betreten feuertrunken,\n" + "Himmlische, dein Heiligtum!\n" + "Deine Zauber binden wieder\n"
			+ "Was die Mode streng geteilt;\n" + "Alle Menschen werden Brüder,\n" + "Wo dein sanfter Flügel weilt.";

	// Dutch national anthem
	private String Wilhelmus = "Wilhelmus van Nassouwe\n" + "ben ik, van Duitsen bloed,\n" + "den vaderland getrouwe\n"
			+ "blijf ik tot in den dood.\n" + "Een Prinse van Oranje\n" + "ben ik, vrij, onverveerd,\n"
			+ "den Koning van Hispanje\n" + "heb ik altijd geëerd.";

	// American national anthem
	private String StarSpangledBanner = "O say can you see by the dawn's early light,\n"
	...
	@Test
	public void multipleThreadsGetUsed() throws InterruptedException, ExecutionException {
		...
		ForkJoinPool multiThreadPool = new ForkJoinPool(4, factory, null, false);
		...
		Map<Integer, Integer> multiCounts = multiThreadPool
				.submit(() -> (new ParallelLetterFrequency(b.toString()).letterCounts())).get();

		boolean startedThreadCountEqualsPoolSize = allThreads.stream().filter(thread -> thread.wasStarted)
