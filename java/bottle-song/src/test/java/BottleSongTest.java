...
public class BottleSongTest {
  ...
  public void firstGenericVerse() {
    assertThat(bottleSong.recite(10, 1))
        .isEqualTo(
  ...
  public void lastGenericVerse() {
    assertThat(bottleSong.recite(3, 1))
        .isEqualTo(
  ...
  public void verseWithTwoBottles() {
    assertThat(bottleSong.recite(2, 1))
        .isEqualTo(
  ...
  public void verseWithOneBottle() {
    assertThat(bottleSong.recite(1, 1))
        .isEqualTo(
  ...
  public void firstTwoVerses() {
    assertThat(bottleSong.recite(10, 2))
        .isEqualTo(
            "Ten green bottles hanging on the wall,\n"
                + "Ten green bottles hanging on the wall,\n"
                + "And if one green bottle should accidentally fall,\n"
  ...
  public void lastThreeVerses() {
    assertThat(bottleSong.recite(3, 3))
        .isEqualTo(
            "Three green bottles hanging on the wall,\n"
                + "Three green bottles hanging on the wall,\n"
                + "And if one green bottle should accidentally fall,\n"
