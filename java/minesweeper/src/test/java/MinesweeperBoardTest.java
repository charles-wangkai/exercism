...
public class MinesweeperBoardTest {
	...
	public void testInputBoardWithSingleMineAtCenter() {
		...
		final List<String> expectedNumberedBoard = Arrays.asList("111", "1*1", "111");
	...
	public void testInputBoardWithMinesAroundPerimeter() {
		...
		final List<String> expectedNumberedBoard = Arrays.asList("***", "*8*", "***");
	...
	public void testInputBoardWithSingleRowAndTwoMines() {
		...
		final List<String> expectedNumberedBoard = Collections.singletonList("1*2*1");
	...
	public void testInputBoardWithSingleRowAndTwoMinesAtEdges() {
		...
		final List<String> expectedNumberedBoard = Collections.singletonList("*1 1*");
	...
	public void testInputBoardWithSingleColumnAndTwoMines() {
		...
		final List<String> expectedNumberedBoard = Arrays.asList("1", "*", "2", "*", "1");
	...
	public void testInputBoardWithSingleColumnAndTwoMinesAtEdges() {
		...
		final List<String> expectedNumberedBoard = Arrays.asList("*", "1", " ", "1", "*");
	...
	public void testInputBoardWithMinesInCross() {
		...
		final List<String> expectedNumberedBoard = Arrays.asList(" 2*2 ", "25*52", "*****", "25*52", " 2*2 ");
	...
	public void testLargeInputBoard() {
		...
		final List<String> expectedNumberedBoard = Arrays.asList("1*22*1", "12*322", " 123*2", "112*4*", "1*22*2",
				"111111");
