...
public class SchoolTest {
	...
	public void sortsSchool() {
		...
		sortedStudents.put(6, IsIterableContainingInOrder.contains("Kareem"));
		sortedStudents.put(4, IsIterableContainingInOrder.contains("Adam", "Christopher", "Jennifer", "Kyle", "Zed"));
		sortedStudents.put(3, IsIterableContainingInOrder.contains("Kylie"));
	...
	public void modifyingFetchedGradeShouldNotModifyInternalDatabase() {
		...
		try {
			...
			// Such as UnsupportedOperationException when an umodifiable collection type is
			// used
		}
