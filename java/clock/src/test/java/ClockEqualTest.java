...
public class ClockEqualTest {
  ...
  public void clocksAMinuteApartAreNotEqual() {
    assertThat(new Clock(15, 36)).isNotEqualTo(new Clock(15, 37));
  }
  ...
  public void clocksWithHourOverflow() {
    assertThat(new Clock(34, 37)).isEqualTo(new Clock(10, 37));
  }

  @Test
  public void clocksWithHourOverflowBySeveralDays() {
    assertThat(new Clock(99, 11)).isEqualTo(new Clock(3, 11));
  }

  @Test
  public void clocksWithNegateHour() {
    assertThat(new Clock(-2, 40)).isEqualTo(new Clock(22, 40));
  }

  @Test
  public void clocksWithNegativeHourThatWraps() {
    assertThat(new Clock(-31, 3)).isEqualTo(new Clock(17, 3));
  }
  ...
  public void clocksWithNegativeMinutes() {
    assertThat(new Clock(3, -20)).isEqualTo(new Clock(2, 40));
  }

  @Test
  public void clocksWithNegativeMinutesThatWraps() {
    assertThat(new Clock(5, -1490)).isEqualTo(new Clock(4, 10));
  }

  @Test
  public void clocksWithNegativeMinutesThatWrapsMultipleTimes() {
    assertThat(new Clock(6, -4305)).isEqualTo(new Clock(6, 15));
  }

  @Test
  public void clocksWithNegativeHoursAndMinutes() {
    assertThat(new Clock(-12, -268)).isEqualTo(new Clock(7, 32));
  }
