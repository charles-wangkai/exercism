...
public class ZipperTest {
	...
	public void testSetValue() {
		...
		zipper = zipper.left;
		zipper.setValue(5);
		String expected = "value: 1, " + "left: { " + "value: 5, " + "left: null, " + "right: { " + "value: 3, "
				+ "left: null, " + "right: null } }, " + "right: { " + "value: 4, " + "left: null, " + "right: null }";
	...
	public void testSetLeftWithLeaf() {
		...
		String expected = "value: 1, " + "left: { " + "value: 2, " + "left: { " + "value: 5, " + "left: null, "
				+ "right: null }, " + "right: { " + "value: 3, " + "left: null, " + "right: null } }, " + "right: { "
	...
	public void testSetRightWithNull() {
		...
		String expected = "value: 1, " + "left: { value: 2, left: null, right: null }, "
	...
	public void testSetRightWithSubtree() {
		...
		String expected = "value: 1, " + "left: { " + "value: 2, " + "left: null, " + "right: { " + "value: 3, "
				+ "left: null, " + "right: null } }, " + "right: { " + "value: 6, " + "left: { " + "value: 7, "
				+ "left: null, " + "right: null }, " + "right: { " + "value: 8, " + "left: null, " + "right: null } }";
		assertEquals(expected, zipper.toTree().printTree());
	}
	...
	public void testSetValueOnDeepFocus() {
		...
		zipper.setValue(5);
		String expected = "value: 1, " + "left: { " + "value: 2, " + "left: null, " + "right: { " + "value: 5, "
				+ "left: null, " + "right: null } }, " + "right: { " + "value: 4, " + "left: null, " + "right: null }";
		assertEquals(expected, zipper.toTree().printTree());
	}
