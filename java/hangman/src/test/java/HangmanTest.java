...
public class HangmanTest {
    ...
    public void initialization() {
        Observable<Output> result = hangman.play(Observable.fromArray("secret"), Observable.fromArray());
    ...
    public void firstGuess() {
        Observable<Output> result = hangman.play(Observable.fromArray("secret"), Observable.fromArray("e"));
    ...
    public void firstMiss() {
        Observable<Output> result = hangman.play(Observable.fromArray("secret"), Observable.fromArray("a"));
        Output last = result.blockingLast();
    ...
    public void gameInProgress() {
        Observable<Output> result = hangman.play(Observable.fromArray("secret"),
        ...
        assertEquals(Arrays.asList(Part.HEAD, Part.BODY), last.parts);
        assertEquals(Status.PLAYING, last.status);
    }
    ...
    public void lostGame() {
        ...
        assertEquals(Arrays.asList(Part.HEAD, Part.BODY, Part.LEFT_ARM, Part.RIGHT_ARM, Part.LEFT_LEG, Part.RIGHT_LEG),
                last.parts);
    }
    ...
    public void cannotPlayAGuessTwice() {
        ...
        assertThatThrownBy(() -> result.blockingLast()).isInstanceOf(IllegalArgumentException.class)
