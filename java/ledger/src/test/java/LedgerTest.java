...
public class LedgerTest {
  ...
  public void oneEntry() {
    // given
    var entries =
        new Ledger.LedgerEntry[] {ledger.createLedgerEntry("2015-02-01", "Buy present", -10.00)};
  ...
  public void euros() {
    // given
    var entries =
        new Ledger.LedgerEntry[] {ledger.createLedgerEntry("2015-01-01", "Buy present", -10.00)};
  ...
  public void dutchLocale() {
    // given
    var entries =
        new Ledger.LedgerEntry[] {ledger.createLedgerEntry("2015-03-12", "Buy present", 1234.56)};
  ...
  public void dutchNegativeNumberWith3DigitsBeforeDecimalPoint() {
    // given
    var entries =
        new Ledger.LedgerEntry[] {ledger.createLedgerEntry("2015-03-12", "Buy present", -123.45)};
  ...
  public void givenInvalidLocale_ThenException() {
    ...
    IllegalArgumentException illegalArgumentException =
        assertThrows(
            IllegalArgumentException.class, () -> ledger.format(EUR_CURRENCY, locale, entries));
  ...
  public void givenInvalidCurrency_ThenException() {
    ...
    IllegalArgumentException illegalArgumentException =
        assertThrows(
            IllegalArgumentException.class, () -> ledger.format(currency, US_LOCALE, entries));
